...
pub async fn add_photo_db(
    ...
    let execute = sqlx::query!(
        ...
        (photo_category_id, tv_series_id, photo_url, preview_url, author, create_time, update_time)
...
pub async fn update_photo_db(
    ...
    let execute = sqlx::query!(
        ...
        set photo_category_id = $1, tv_series_id = $2, photo_url = $3, preview_url = $4, author = $5, update_time = $6
        where id = $7"#,
        data.photo_category_id,
        data.tv_series_id,
        data.photo_url,
